...
/**
 * Creamos varios objetos pokémon
 */
...
/**
 * Los metemos dentro de un array, la Pokédex, nuestra base de datos.
 */
...
const aleatorio = Math.floor(Math.random() * Pokedex.length); // escoge un pokémon aleatorio para nuestro rival
